package native_java.network.mail.a_send;
...
public class b_SendMailHTML {

    public static void main(String[] args) {
        b_SendMailHTML sendMailHTML = new b_SendMailHTML();
        ...
        boolean sent = sendMailHTML.sendEmailTLS(recipients, subject, html);
     ...
     */
    public boolean sendEmailSSL(List<String> recipients, String subject, String html) {
     ...
     * @return boolean - whether email was sent
     */
    public boolean sendEmailTLS(List<String> recipients, String subject, String html) {
        if(!activated) return true;
...
//        props.put("network.mail.smtp.port", "587");
     ...
     */
    private boolean sendEmail(Properties props, List<String> recipients, String subject, String html) {
